...
while True:
    ...
    for ship in team_ships:
        ...
        if full_attack_mode==False:
            if len(planetas_factibles)>0 and (ship.calculate_distance_between(planetas_factibles[0])<5 or ship.calculate_distance_between(closest_enemy_ships[0])>15):
